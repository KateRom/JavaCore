...
public class StringToBoleanTest {
    ...
    @FileParameters(RESOURCES_PATH + "string2primitive/str2boolean.txt")

    @Test
    public void strToBoleanTest(boolean expResult, String a){
        Assert.assertEquals(expResult, PrimitiveToStringAndBack.stringToBoolean(a));
    }
}
